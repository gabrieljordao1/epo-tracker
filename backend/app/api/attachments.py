...
from ..core.security import sanitize_filename, audit_log
...
async def upload_attachment(
    ...
    try:
        ...
        audit_log(
            ...
            email=current_user.email,
            status="success",
            details={"epo_id": epo_id, "attachment_id": attachment.id, "file_size": len(contents)}
        )
